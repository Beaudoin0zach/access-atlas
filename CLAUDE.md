...
- ⏳ **Deferred (needs a decision, not just code):** a user-facing **"report this photo"** surface — still gated on public contributions opening (they are NOT open yet), since a report queue with no public contributors is premature.
